				...
				columns_list: [
					[
						...
						},
						{
							type: 'ghElement',
							property:
								'data_model.column_item_reference_field_id',
							data_model: function (fieldModel) {
								return {
									data_type: 'field',
						...
						},
						{
							...
							control:
								'<gh-filter gh-filter-data-model="field_model" filter-list="fieldModel.data_model.record_filters_list" gh-mode="variable"></gh-filter>'
						}
					],
					[
						{
						...
						},
						{
							...
							data_model: function (fieldModel) {
								return {
									...
									data_model: {
										app_id: fieldModel.data_model.row_app_id
									}
								};
							},
							onInit: function (settingScope, fieldModel) {
								settingScope.$watch(
									function () {
										return fieldModel.data_model.row_app_id;
									},
									function (newValue) {
										settingScope.field_model.data_model.app_id =
											newValue;
									...
									patterns: [
										...
										},
										{
											...
											data_model: function (option) {
												return {
													options: Object.values(
														reportSettingProperties.aggregation
													).map((aggregation) => ({
														name: aggregation,
														value: aggregation
													}))
										...
										},
										{
											...
											data_model: function (
												...
												scope.appId =
													fieldModel.data_model.records_app_id;
